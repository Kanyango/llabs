...
var opport = {
	...
	create : function(req , res , next)
	{
		...
		req.app.db.models.Opport.create(fieldsToSet,
           function(err ,  docs){
	...
	read : function(req , res , next)
	{
		...
		req.app.db.models.Opport.find({user: req.payload._id},
		    function(err , docs)
			{
				if(err)
				{
	...
	remove : function(req , res , next)
	{
	  	...
	  	req.app.db.models.Opport.findByIdAndRemove(req.params.id, 
	  		function(err , info){
	  			if(err)
	  			{
	  				return next(err);
